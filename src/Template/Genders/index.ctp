    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($gender->NAME) ?></td>
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $gender->idGENDER]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $gender->idGENDER]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $gender->idGENDER], ['confirm' => __('Are you sure you want to delete # {0}?', $gender->idGENDER)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
